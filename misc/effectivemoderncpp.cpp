...
// clang++ -std=c++14 -o effectivemoderncpp effectivemoderncpp.cpp
...
{
    return std::tuple<std::string, std::string>(type_id_with_cvr<T>().pretty_name(), type_id_with_cvr<decltype(param)>().pretty_name());
}
